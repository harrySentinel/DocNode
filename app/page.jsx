    ...
    <div className="bg-background">
      ...
      <section className="py-20 bg-muted/30">
       ...
       <section className="py-20">
        <div className="container mx-auto px-4">
                <Card
                  className="bg-gradient-to-r from-emerald-800/40 via-emerald-900/30 to-emerald-950/20 border border-emerald-800/20"
                >
                  <CardContent className="p-8 md:p-12 lg:p-16 relative overflow-hidden">
                   <div>
                    ...
                    <p className="text-lg text-muted-foreground mb-8">
                     Say goodbye to long waiting rooms and confusing processes. Our platform empowers you to connect with certified doctors, manage your health records, and get expert care—anytime, anywhere.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4">
                      <Button 
                      size="lg"
